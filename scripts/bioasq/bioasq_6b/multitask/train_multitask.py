...
if __name__ == "__main__":
    ...
    raw_train = load_dataset("json", data_files="datasets/multitask_bioasq6b_train.json")['train']
    raw_val = load_dataset("json", data_files="datasets/multitask_bioasq6b_val.json")['train']
