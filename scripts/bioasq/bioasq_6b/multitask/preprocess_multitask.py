...
if __name__ == "__main__":
    ...
    # Path to your official BioASQ training file (e.g., trainingDataset6b.json)
    train_dataset_raw = load_and_process_multitask_bioasq(
        'datasets/BioASQ-training6b/BioASQ-training6b/trainingDataset6b.json', 
        is_training=True
    )
    ...
    train_dataset_raw.to_json("datasets/multitask_bioasq6b_train.json", orient="records", lines=True)
    val_dataset_raw.to_json("datasets/multitask_bioasq6b_val.json", orient="records", lines=True)

    print("The training dataset is saved as `multitask_bioasq6b_train.json` and the validation dataset as `multitask_bioasq6b_val.json` in datasets directory.")