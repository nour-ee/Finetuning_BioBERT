...
if __name__ == "__main__":
    pipeline = BioASQRoutingPipeline(
        qa_model_path="./biobert_bioasq6b_fact_list_model", 
        yesno_model_path="./biobert_bioasq6b_yesno_model"
    )
    ...
    if all_dfs:
        ...
        output_csv = "./results/pipeline_predictions_combined_6B2_6B5.csv"
